...
<head>
    ...
    <title>Petfolio | <?php echo $fetch_info['name'] ?></title>
    <!-- Favicon -->
...
<?php } ?>
    ...
    <div class="main-body">
        ...
        <li class="nav-item1">
          <a class="nav-link " id="pills-home-tab" data-toggle="pill" href="profile.php" role="tab" aria-controls="pills-home" aria-selected="true">User Profile</a>
        </li>
        <li class="nav-item1">
          <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="Petfolio1.php" role="tab" aria-controls="pills-profile" aria-selected="true">PetFolio</a>
        </li>
      </ul>
  </nav> -->
    
 <nav>
    <ul class="nav nav-pills mb-4 shadow-lg">
  <li class="nav-item1">
    <a class="nav-link"  href="profile.php">User Profile</a>
  </li>
  <li class="nav-item1">
    <a class="nav-link active" aria-current="page" href="Petfolio1.php">Petfolio</a>
  </li>
  <!-- <li class="nav-item">
              ...
              <div class="card">
                <div class="card-body shadow-lg">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="https://i.postimg.cc/FKH6FS3P/petfolo.jpg" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4> <?php echo $petname; ?></h4>
                      <p class="text-secondary mb-1">PET</p>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body shadow-lg">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="Pet_edit.php">Edit</a>
