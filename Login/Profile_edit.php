        ...
        <nav class="navbar fixed-top navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5 ">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse" >
                <div class="navbar-nav ms-auto py-0">
                    <a href="Profile_edit.php" class="nav-item nav-link active">Edit</a>
        ...
        <?php 
                    if(isset($_SESSION['condition']))
                    {
                        ?>
                            ...
                            <strong>Hey!</strong> <?php echo $_SESSION['condition']; ?>
 ...
 <div class="row">
           ...
           <div class="profile-card-4">
            <div class="card z-depth-3">
              <div class="card-body text-center bg-primary rounded-top">
               <div class="user-box">
                <img src="https://i.postimg.cc/HxDF7zWZ/ownern3.jpg" alt="user avatar">
              </div>
              <h5 class="mb-1 text-white"><?php echo $fetch_info['name'] ?></h5>
              <h6 class="text-light">UserID: <?php echo $fetch_info['userid'] ?></h6>
           ...
           <div class="card z-depth-3 ">
            ...
            <div class="tab-content p-3">
                 <div class="tab-pane active">
                    <form action="petupdate.php" method="POST">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">User ID</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" readonly name="userid" value="<?php echo $fetch_info['userid'] ?>" >
                            </div>
                        </div>
                         <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" readonly type="email" name="email" value="" placeholder="<?php echo $fetch_info['email'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Full name</label>
                            <div class="col-lg-9">
                                <!-- <input class="form-control" required type="text" name="name" value="<?php echo $fetch_info['name'] ?>" placeholder="<?php echo $fetch_info['name'] ?>"> -->
                                 <input class="form-control" required type="text" name="name" pattern="[A-Za-z ]+" value="<?php echo $fetch_info['name'] ?>" placeholder="<?php echo $fetch_info['name'] ?>">
      <small class="text-muted">Only characters and spaces are allowed</small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <!-- <input class="form-control" required type="phone" name="phone" value="<?php echo $fetch_info['phone'] ?>"  placeholder="<?php echo $fetch_info['phone'] ?>"> -->
                                <input class="form-control" required type="tel" name="phone" pattern="[0-9]{10}" value="<?php echo $fetch_info['phone'] ?>" placeholder="<?php echo $fetch_info['phone'] ?>">
      <small class="text-muted">Only 10 digits number allowed</small>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label"></label>
                            <div class="col-lg-9">
                                <input type="submit" name="update_cancel" class="btn  btn-primary btn-outline-secondary text-dark pl-4 pr-4 nohover" value="Cancel">
                                <input type="submit" name="update_profile" class="btn btn-primary btn-outline-secondary text-white" value="Save Changes">
                            </div>
                        </div>
                    </form>
                </div> 
