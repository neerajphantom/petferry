...
if(isset($_POST['delete_btn']))
{
    ...
    $query = "DELETE FROM petusers WHERE userid='$userid' ";
    ...
    if($query_run)
    {
     ...
     header("Refresh:1; url=adminown1.php");
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>PetFerry | Admin | Pet Owners</title>
...
<div class="navigation">
  ...
  <div class="logout">BACK</div>
    ...
    <!-- <div class="card shadow mb-4"> -->
         <div class="row">
    <div class="col-md-4">
       <h1 class="text-white">Pet Owners</h1> 
    </div>
...
<?php } ?>
        ...
        <!-- <div class="card-header py-3">
            <h1 class="m-0 font-weight-bold newh1">Pet Owners Data</h1>

        </div> -->
        <div class="card-body">
            <div class="table-responsive">
            <?php
                $query = "SELECT * FROM petusers";
                $query_run = mysqli_query($con, $query);
            ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="adminown1.php" method="post">
